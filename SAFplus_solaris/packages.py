...
class OS:
    ...
    def load_install_deps(self):
        ...
        pdb.set_trace()
        TIPC_CONFIG.name           = 'tipcutils'
        TIPC_CONFIG.version        = '1.0.4'
        TIPC_CONFIG.pkg_name       = 'tipcutils-1.0.4.tar.gz' #default name, can change
        ...
        #else:
        self.dep_list = [gcc, glib, openhpi, netsnmp, openhpisubagent, TIPC, TIPC_CONFIG, JRE, ECLIPSE, EMF, GEF]
        #self.dep_list = [gcc, glibc, glib, openhpi, netsnmp, openhpisubagent, JRE, ECLIPSE, EMF, GEF, CDT, sqlite]        
