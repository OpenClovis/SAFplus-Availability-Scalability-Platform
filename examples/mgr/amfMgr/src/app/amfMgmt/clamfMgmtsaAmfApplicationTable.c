/******************************************************************************
 *
 * clamfMgmtsaAmfApplicationTable.c
 *
 ******************************************************************************
...
ClRcT clamfMgmtSAAMFAPPLICATIONTABLEProvConstructor( void *pThis, void *pUsrData, ClUint32T usrDataLen )
{
    ...
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectStart = clamfMgmtSAAMFAPPLICATIONTABLEProvObjectStart;      
    ((CL_OM_PROV_CLASS*)pThis)->clProvValidate = (fp)clamfMgmtSAAMFAPPLICATIONTABLEProvValidate;    
    ((CL_OM_PROV_CLASS*)pThis)->clProvUpdate = (fp)clamfMgmtSAAMFAPPLICATIONTABLEProvUpdate;    
    ((CL_OM_PROV_CLASS*)pThis)->clProvRollback = (fp)clamfMgmtSAAMFAPPLICATIONTABLEProvRollback;
    ((CL_OM_PROV_CLASS*)pThis)->clProvRead = (fp)clamfMgmtSAAMFAPPLICATIONTABLEProvRead;
	((CL_OM_PROV_CLASS*)pThis)->clProvObjectValidate = clamfMgmtSAAMFAPPLICATIONTABLEProvObjectValidate; 	 
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectUpdate = clamfMgmtSAAMFAPPLICATIONTABLEProvObjectUpdate; 	 
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectRollback = clamfMgmtSAAMFAPPLICATIONTABLEProvObjectRollback;
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectRead = clamfMgmtSAAMFAPPLICATIONTABLEProvObjectRead;
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectEnd = clamfMgmtSAAMFAPPLICATIONTABLEProvObjectEnd;      
 ...
 * clamfMgmtSAAMFAPPLICATIONTABLEOAMPConfig.h for detailed documentation for this function.
 */
 ...
 * Please refer protptype of this function in the file clamfMgmtSAAMFAPPLICATIONTABLEOAMPConfig.h
