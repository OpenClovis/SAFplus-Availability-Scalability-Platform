...
ClRcT clamfMgmtSAAMFCOMPCSTYPESUPPORTEDTABLEProvConstructor( void *pThis, void *pUsrData, ClUint32T usrDataLen )
{
	...
	((CL_OM_PROV_CLASS*)pThis)->clProvObjectValidate = clamfMgmtSAAMFCOMPCSTYPESUPPORTEDTABLEProvObjectValidate; 	 
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectUpdate = clamfMgmtSAAMFCOMPCSTYPESUPPORTEDTABLEProvObjectUpdate; 	 
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectRollback = clamfMgmtSAAMFCOMPCSTYPESUPPORTEDTABLEProvObjectRollback;
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectRead = clamfMgmtSAAMFCOMPCSTYPESUPPORTEDTABLEProvObjectRead;
 ...
 * Please refer protptype of this function in the file clamfMgmtSAAMFCOMPCSTYPESUPPORTEDTABLEOAMPConfig.h
