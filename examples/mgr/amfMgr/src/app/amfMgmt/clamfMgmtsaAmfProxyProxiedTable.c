/******************************************************************************
 *
 * clamfMgmtsaAmfProxyProxiedTable.c
 *
 ******************************************************************************
...
ClRcT clamfMgmtSAAMFPROXYPROXIEDTABLEProvConstructor( void *pThis, void *pUsrData, ClUint32T usrDataLen )
{
    ...
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectStart = clamfMgmtSAAMFPROXYPROXIEDTABLEProvObjectStart;      
    ((CL_OM_PROV_CLASS*)pThis)->clProvValidate = (fp)clamfMgmtSAAMFPROXYPROXIEDTABLEProvValidate;    
    ((CL_OM_PROV_CLASS*)pThis)->clProvUpdate = (fp)clamfMgmtSAAMFPROXYPROXIEDTABLEProvUpdate;    
    ((CL_OM_PROV_CLASS*)pThis)->clProvRollback = (fp)clamfMgmtSAAMFPROXYPROXIEDTABLEProvRollback;
    ((CL_OM_PROV_CLASS*)pThis)->clProvRead = (fp)clamfMgmtSAAMFPROXYPROXIEDTABLEProvRead;
	((CL_OM_PROV_CLASS*)pThis)->clProvObjectValidate = clamfMgmtSAAMFPROXYPROXIEDTABLEProvObjectValidate; 	 
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectUpdate = clamfMgmtSAAMFPROXYPROXIEDTABLEProvObjectUpdate; 	 
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectRollback = clamfMgmtSAAMFPROXYPROXIEDTABLEProvObjectRollback;
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectRead = clamfMgmtSAAMFPROXYPROXIEDTABLEProvObjectRead;
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectEnd = clamfMgmtSAAMFPROXYPROXIEDTABLEProvObjectEnd;      
 ...
 * clamfMgmtSAAMFPROXYPROXIEDTABLEOAMPConfig.h for detailed documentation for this function.
 */
 ...
 * Please refer protptype of this function in the file clamfMgmtSAAMFPROXYPROXIEDTABLEOAMPConfig.h
