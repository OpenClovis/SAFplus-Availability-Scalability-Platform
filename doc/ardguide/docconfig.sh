...
export DOCID=awdguide

#-----------------------------------------------------------------------------
# Documentation full name appears in Documentation HTML Main Page and 
# Title PDF Page 
#
export DOCTITLE=User Guide

#-----------------------------------------------------------------------------
# Wiki page URL
# e.g.:
# http://192.168.0.94:8080/wiki/index.php/Doc:HaDemoModelGuide ---> WIKI_URL=Doc:sdk_4.1/awdguideDoc:HaDemoModelGuide
# http://192.168.0.94:8080/wiki/index.php/Documentation ---> WIKI_URL=Doc:sdk_4.1/awdguideDocumentation  
export WIKI_URL=Doc:sdk_4.1/awdguide
...
#
export INPUT_WIKI_FORMAT=multipage
...
#       OUTPUT_HTML_FORMAT=singlepagesinglepage TO GET CORRECT TABLE OF CONTENTS.
...
# PRODUCT_NAME=
export PRODUCT_NAME="OpenClovis ASP Runtime Director"
