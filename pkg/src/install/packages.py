...
class OS:
    ...
    def load_install_deps(self):
        ...
        openhpi.version        = '2.16.0'
        openhpi.pkg_name       = 'openhpi-2.16.0.tar.gz'
        ...
        self.dep_list = [gcc, glibc, glib, openhpi, openhpisubagent, netsnmp, TIPC, TIPC_CONFIG, JRE, ECLIPSE, EMF, GEF, CDT]
