...
int main(int argc, char **argv)
{
    ...
    int rtpId = 0;
    const char *args[] = {"asp_amf", "-c", aspArgs.chassis, "-l", aspArgs.slot, "-n", aspArgs.node, NULL, NULL};
    char aspImage[256];
    char **env = NULL;
    int c;
    int required = 0;
    ...
    {
        printf("MMAP doesnt work. Hence ASP component asp_logd wont function properly\n");
    }
#endif
    ...
    snprintf(aspImage, sizeof(aspImage)-1, "%s/bin/asp_amf", aspArgs.targetBase);
