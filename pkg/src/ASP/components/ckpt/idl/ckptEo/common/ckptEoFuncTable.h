...
CL_EO_CALLBACK_TABLE_DECL(gCkptEoFuncList)[] =
{
	...
	VSYM_VER(_ckptCheckpointWriteVectorServer, 4, 0, 0, CL_EO_GET_FULL_FN_NUM(CL_EO_NATIVE_COMPONENT_TABLE_ID, 46)),
	VSYM_VER(_ckptSectionOverwriteVectorServer, 4, 0, 0, CL_EO_GET_FULL_FN_NUM(CL_EO_NATIVE_COMPONENT_TABLE_ID, 47)),
	VSYM_VER(clCkptRemSvrCkptWriteVectorServer, 4, 0, 0, CL_EO_GET_FULL_FN_NUM(CL_EO_NATIVE_COMPONENT_TABLE_ID, 48)),
