...
*********************************************************************/
/*********************************************************************
* Description : Marshall routine for ClCkptVersionT
*     
...
#include "xdrClCkptVersionT.h"

ClRcT clXdrMarshallClCkptVersionT_4_0_0(void* pGenVar, ClBufferHandleT msg, ClUint32T isDelete)
{
    ClCkptVersionT_4_0_0* pVar = (ClCkptVersionT_4_0_0*)pGenVar;
    ClRcT rc         = CL_OK;
    ClUint32T length = 0;    
