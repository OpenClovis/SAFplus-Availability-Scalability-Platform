...
static void
clCkptTipcNodedownCallback(ClIocNotificationIdT eventId, 
                           ClPtrT               pArg,
                           ...
                           ClIocAddressT        *pAddress)
{
        ...
        pAddress->iocPhyAddress.nodeAddress == gCkptSvr->masterInfo.masterAddr)
    {
         ...
         * master is shutting down or killed, so deputy will become the new
...
clCkptTipcCallbackUpdate(void)
{
    ...
    clCpmNotificationCallbackInstall(compAddr, clCkptTipcNodedownCallback, 
