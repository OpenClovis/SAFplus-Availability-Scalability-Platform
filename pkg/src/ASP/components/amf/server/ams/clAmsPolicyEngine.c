...
static ClRcT clAmsPeSGCheckSUHigherRank(ClAmsSGT *sg, ClAmsSUT *su,ClAmsSIT *si);
static ClRcT clAmsPeSGCheckSUAssignmentDelay(ClAmsSGT *sg);
 ...
 * to the same node.
 */
static ClBoolT clAmsPeCheckDependencySIInNode(ClAmsSIT *si, ClAmsSUT *su, ClUint32T level)
{
...
static ClRcT clAmsPeSISwapMPlusN(ClAmsSIT *si, ClAmsSGT *sg)
{
    ClAmsSUT *activeSU = NULL;
    ClAmsSUT *standbySU = NULL;
    ClAmsEntityRefT *eRef = NULL;
