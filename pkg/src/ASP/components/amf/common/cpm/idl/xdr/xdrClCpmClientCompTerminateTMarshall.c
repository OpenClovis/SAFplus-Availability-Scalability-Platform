...
*********************************************************************/
/*********************************************************************
* Description : Marshall routine for ClCpmClientCompTerminateT
*     
...
ClRcT clXdrMarshallClCpmClientCompTerminateT_4_0_0(void* pGenVar, ClBufferHandleT msg, ClUint32T isDelete)
{
