...
*********************************************************************/
/*********************************************************************
* Description : Unmarshall routine for clAmsMgmtEntityLockAssignmentRequestT
*     
...
ClRcT clXdrUnmarshallclAmsMgmtEntityLockAssignmentRequestT_4_0_0(ClBufferHandleT msg , void* pGenVar)
{
