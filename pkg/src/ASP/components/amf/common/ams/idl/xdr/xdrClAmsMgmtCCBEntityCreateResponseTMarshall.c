...
*********************************************************************/
/*********************************************************************
* Description : Marshall routine for clAmsMgmtCCBEntityCreateResponseT
*     
...
ClRcT clXdrMarshallclAmsMgmtCCBEntityCreateResponseT_4_0_0(void* pGenVar, ClBufferHandleT msg, ClUint32T isDelete)
{
