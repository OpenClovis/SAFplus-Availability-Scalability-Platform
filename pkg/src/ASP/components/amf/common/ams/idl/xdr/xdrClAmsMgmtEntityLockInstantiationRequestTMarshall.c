...
*********************************************************************/
/*********************************************************************
* Description : Marshall routine for clAmsMgmtEntityLockInstantiationRequestT
*     
...
ClRcT clXdrMarshallclAmsMgmtEntityLockInstantiationRequestT_4_0_0(void* pGenVar, ClBufferHandleT msg, ClUint32T isDelete)
{
