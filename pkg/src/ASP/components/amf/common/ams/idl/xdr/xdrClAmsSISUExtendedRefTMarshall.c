...
*********************************************************************/
/*********************************************************************
* Description : Marshall routine for ClAmsSISUExtendedRefT
*     
...
ClRcT clXdrMarshallClAmsSISUExtendedRefT_4_0_0(void* pGenVar, ClBufferHandleT msg, ClUint32T isDelete)
{
