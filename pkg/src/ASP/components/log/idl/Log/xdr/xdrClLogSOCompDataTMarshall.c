...
*********************************************************************/
/*********************************************************************
* Description : Marshall routine for ClLogSOCompDataT
*     
...
ClRcT clXdrMarshallClLogSOCompDataT_4_0_0(void* pGenVar, ClBufferHandleT msg, ClUint32T isDelete)
{
    ClLogSOCompDataT_4_0_0* pVar = (ClLogSOCompDataT_4_0_0*)pGenVar;
    ClRcT rc         = CL_OK;
    ClUint32T length = 0;    
