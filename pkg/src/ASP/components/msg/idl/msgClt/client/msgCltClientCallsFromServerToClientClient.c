...
static void clMsgClientsMessageReceiveCallbackAsyncCallback_4_0_0(ClRcT rc, void *pIdlCookie, ClBufferHandleT inMsgHdl, ClBufferHandleT outMsgHdl)
{
    ClIdlCookieT* pCookie = (ClIdlCookieT*)pIdlCookie;
    ClRcT retVal = CL_OK;
    ClHandleT  clientHandle;
    ...
    retVal = clXdrUnmarshallClHandleT(inMsgHdl, &(qHandle));
    if (CL_OK != retVal)
    {
        goto L1;
    }
    ...
    ((MsgCltClMsgClientsMessageReceiveCallbackAsyncCallbackT_4_0_0)(pCookie->actualCallback))(pCookie->handle, clientHandle, qHandle, retVal, pCookie->pCookie);
    goto L2;
...
ClRcT clMsgClientsMessageReceiveCallbackClientAsync_4_0_0(CL_IN ClIdlHandleT handle, CL_IN ClHandleT  clientHandle, CL_IN ClHandleT  qHandle,CL_IN MsgCltClMsgClientsMessageReceiveCallbackAsyncCallbackT_4_0_0 fpAsyncCallback, CL_IN void *cookie)
{
    ClRcT rc = CL_OK;
    ClVersionT funcVer = {4, 0, 0};
    ClUint32T funcNo = CL_EO_GET_FULL_FN_NUM(CL_MSG_CLIENT_TABLE_ID, 1);
    ClBufferHandleT inMsgHdl = 0;
    ClBufferHandleT outMsgHdl = 0;
    ClIocAddressT address = {{0}};
    ClIdlHandleObjT* pHandleObj = NULL;
    ...
    if(fpAsyncCallback != NULL)
    {
        ...
        pCookie->handle = handle;
        asyncOptions.pCookie = pCookie;
        asyncOptions.fpCallback = clMsgClientsMessageReceiveCallbackAsyncCallback_4_0_0;
