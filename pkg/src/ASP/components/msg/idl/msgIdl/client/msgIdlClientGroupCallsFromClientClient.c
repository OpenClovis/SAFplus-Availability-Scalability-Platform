...
ClRcT clMsgClientQueueGroupCreateClientSync_4_0_0(CL_IN ClIdlHandleT handle, CL_IN ClHandleT msgHandle, CL_IN ClNameT* pGroupName, CL_IN SaMsgQueueGroupPolicyT_4_0_0 groupPolicy)
{
    ClRcT rc = CL_OK;
...
ClRcT clMsgClientQueueGroupDeleteClientSync_4_0_0(CL_IN ClIdlHandleT handle, CL_IN ClHandleT msgHandle, CL_IN ClNameT* pGroupName)
{
    ClRcT rc = CL_OK;
    ClVersionT funcVer = {4, 0, 0};
...
ClRcT clMsgClientQueueGroupInsertClientSync_4_0_0(CL_IN ClIdlHandleT handle, CL_IN ClHandleT msgHandle, CL_IN ClNameT* pGroupName, CL_IN ClNameT* pQueueName)
{
    ClRcT rc = CL_OK;
    ClVersionT funcVer = {4, 0, 0};
...
ClRcT clMsgClientQueueGroupRemoveClientSync_4_0_0(CL_IN ClIdlHandleT handle, CL_IN ClHandleT msgHandle, CL_IN ClNameT* pGroupName, CL_IN ClNameT* pQueueName)
{
    ClRcT rc = CL_OK;
    ClVersionT funcVer = {4, 0, 0};
...
ClRcT clMsgClientQueueGroupTrackClientSync_4_0_0(CL_IN ClIdlHandleT handle, CL_IN ClHandleT clientHandle, CL_IN ClHandleT msgHandle, CL_IN ClNameT* pGroupName, CL_IN ClUint8T trackFlag, CL_INOUT SaMsgQueueGroupNotificationBufferT_4_0_0* pNotificationBuffer)
{
    ClRcT rc = CL_OK;
    ClVersionT funcVer = {4, 0, 0};
...
static void clMsgClientQueueGroupTrackAsyncCallback_4_0_0(ClRcT rc, void *pIdlCookie, ClBufferHandleT inMsgHdl, ClBufferHandleT outMsgHdl)
{
    ...
    ((MsgIdlClMsgClientQueueGroupTrackAsyncCallbackT_4_0_0)(pCookie->actualCallback))(pCookie->handle, clientHandle, msgHandle, &(pGroupName), trackFlag, &(pNotificationBuffer), retVal, pCookie->pCookie);
    goto L5;
...
ClRcT clMsgClientQueueGroupTrackClientAsync_4_0_0(CL_IN ClIdlHandleT handle, CL_IN ClHandleT  clientHandle, CL_IN ClHandleT  msgHandle, CL_IN ClNameT* pGroupName, CL_IN ClUint8T  trackFlag, CL_INOUT SaMsgQueueGroupNotificationBufferT_4_0_0* pNotificationBuffer,CL_IN MsgIdlClMsgClientQueueGroupTrackAsyncCallbackT_4_0_0 fpAsyncCallback, CL_IN void *cookie)
{
    ClRcT rc = CL_OK;
    ClVersionT funcVer = {4, 0, 0};
    ClUint32T funcNo = CL_EO_GET_FULL_FN_NUM(CL_EO_NATIVE_COMPONENT_TABLE_ID, 16);
    ...
    if(fpAsyncCallback != NULL)
    {
        ...
        asyncOptions.fpCallback = clMsgClientQueueGroupTrackAsyncCallback_4_0_0;
...
ClRcT clMsgClientQueueGroupTrackStopClientSync_4_0_0(CL_IN ClIdlHandleT handle, CL_IN ClHandleT msgHandle, CL_IN ClNameT* pGroupName)
{
    ClRcT rc = CL_OK;
    ClVersionT funcVer = {4, 0, 0};
