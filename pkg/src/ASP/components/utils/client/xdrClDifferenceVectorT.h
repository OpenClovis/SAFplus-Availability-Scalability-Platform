...
*               and unmarshall funtions of ClDifferenceVectorT 
*     
...
#ifndef _XDR_CL_DIFFERENCE_VECTOR_T_H_
#define _XDR_CL_DIFFERENCE_VECTOR_T_H_
...
#endif /*_XDR_CL_DIFFERENCE_VECTOR_T_H_*/
