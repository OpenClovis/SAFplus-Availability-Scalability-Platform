...
*********************************************************************/
/*********************************************************************
* Description : Marshall routine for ClEvtChannelOpenRequestT
*     
...
ClRcT clXdrMarshallClEvtChannelOpenRequestT_4_0_0(void* pGenVar, ClBufferHandleT msg, ClUint32T isDelete)
{
