...
*********************************************************************/
/*********************************************************************
* Description : Marshall routine for ClEvtUnsubscribeEventRequestT
*     
...
ClRcT clXdrMarshallClEvtUnsubscribeEventRequestT_4_0_0(void* pGenVar, ClBufferHandleT msg, ClUint32T isDelete)
{
    ClEvtUnsubscribeEventRequestT_4_0_0* pVar = (ClEvtUnsubscribeEventRequestT_4_0_0*)pGenVar;
    ClRcT rc         = CL_OK;
    ClUint32T length = 0;    
    ...
    rc = clXdrMarshallClUint8T(&(pVar->reqFlag),msg,isDelete);
    if (CL_OK != rc)
    {
        return rc;
    }
