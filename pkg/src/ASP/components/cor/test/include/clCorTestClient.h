...
/*******************************************************************************
 * ModuleName  : cor
 * $File: //depot/dev/main/Andromeda/Cauvery/ASP/components/cor/test/clCorTestClient.h $
 * $Author: bkpavan $
 * $Date: 2006/09/14 $
 *******************************************************************************/
...
#define CL_COR_TEST_CLIENT_EO_THREADS          2
#define CL_COR_TEST_CLIENT_IOC_PORT            47
