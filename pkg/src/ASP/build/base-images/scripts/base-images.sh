...
#    fi
    ...
    ${INSTALL} $exe_flags $CLOVIS_ROOT/ASP/build/base-images/scripts/asp_console $imagedir/bin
    ${INSTALL} $exe_flags $CLOVIS_ROOT/ASP/build/base-images/scripts/asp $imagedir/etc/init.d
    ...
    ${INSTALL} $exe_flags $CLOVIS_ROOT/ASP/build/base-images/scripts/amf_watchdog.py $imagedir/etc
