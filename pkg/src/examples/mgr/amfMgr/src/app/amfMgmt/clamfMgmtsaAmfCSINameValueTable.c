/******************************************************************************
 *
 * clamfMgmtsaAmfCSINameValueTable.c
 *
 ******************************************************************************
...
ClRcT clamfMgmtSAAMFCSINAMEVALUETABLEProvConstructor( void *pThis, void *pUsrData, ClUint32T usrDataLen )
{
    ...
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectStart = clamfMgmtSAAMFCSINAMEVALUETABLEProvObjectStart;      
    ((CL_OM_PROV_CLASS*)pThis)->clProvValidate = (fp)clamfMgmtSAAMFCSINAMEVALUETABLEProvValidate;    
    ((CL_OM_PROV_CLASS*)pThis)->clProvUpdate = (fp)clamfMgmtSAAMFCSINAMEVALUETABLEProvUpdate;    
    ((CL_OM_PROV_CLASS*)pThis)->clProvRollback = (fp)clamfMgmtSAAMFCSINAMEVALUETABLEProvRollback;
    ((CL_OM_PROV_CLASS*)pThis)->clProvRead = (fp)clamfMgmtSAAMFCSINAMEVALUETABLEProvRead;
	((CL_OM_PROV_CLASS*)pThis)->clProvObjectValidate = clamfMgmtSAAMFCSINAMEVALUETABLEProvObjectValidate; 	 
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectUpdate = clamfMgmtSAAMFCSINAMEVALUETABLEProvObjectUpdate; 	 
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectRollback = clamfMgmtSAAMFCSINAMEVALUETABLEProvObjectRollback;
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectRead = clamfMgmtSAAMFCSINAMEVALUETABLEProvObjectRead;
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectEnd = clamfMgmtSAAMFCSINAMEVALUETABLEProvObjectEnd;      
 ...
 * clamfMgmtSAAMFCSINAMEVALUETABLEOAMPConfig.h for detailed documentation for this function.
 */
 ...
 * Please refer protptype of this function in the file clamfMgmtSAAMFCSINAMEVALUETABLEOAMPConfig.h
