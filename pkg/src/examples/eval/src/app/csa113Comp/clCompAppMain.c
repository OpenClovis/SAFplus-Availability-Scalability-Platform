...
extern ClRcT clcsa113_EOClientInstall(void);
    ...
    ClCharT *argv[])
{
    ...
    if (rc != CL_OK)
    {
        clprintf(CL_LOG_SEV_ERROR, "Failure opening event channel[0x%x]",
                rc);
        return rc;
    }
    ...
    clprintf(CL_LOG_SEV_INFO, "Instantiated as component instance %s.", appName.value);
    ...
    ClEoStateT eoState)
{
    switch (eoState)
    {
        case CL_EO_STATE_SUSPEND:
        {
            ...
            clprintf(CL_LOG_SEV_INFO, "csa113: Suspending...");
            running = 0;
        ...
        case CL_EO_STATE_RESUME:
        {
            ...
            clprintf(CL_LOG_SEV_INFO, "csa113: Resuming...");
            running = 1;
    ...
    ClAmsCSIDescriptorT csiDescriptor)
{
    ...
    switch ( haState )
    {
        case CL_AMS_HA_STATE_ACTIVE:
        {
            ...
            clprintf(CL_LOG_SEV_INFO, "csa113: ACTIVE state requested; activating service");
            running = 1;
        ...
        case CL_AMS_HA_STATE_STANDBY:
        {
            ...
            clprintf(CL_LOG_SEV_INFO, "csa113: New state is not the ACTIVE; deactivating service");
            running = 0;
        ...
        case CL_AMS_HA_STATE_QUIESCED:
        {
            ...
            clprintf(CL_LOG_SEV_INFO, "csa113: Acknowledging new state");
            running = 0;
        ...
        case CL_AMS_HA_STATE_QUIESCING:
        {
            ...
            clprintf(CL_LOG_SEV_INFO, "csa113: Signaling completion of QUIESCING");
            running = 0;
...
generate_time_of_day(char **data, ClSizeT *data_len)
{
    ...
    if (data == 0 || data_len == 0)
    {
        clprintf(CL_LOG_SEV_ERROR,
                "generate_time_of_day passed null pointer");
        return;
    }
...
generate_load_average(char **data, ClSizeT *data_len)
{
    ...
    {
        clprintf(CL_LOG_SEV_ERROR, "invalid result from read of loadavg");
        return;
    }
    close(fd);
    *data_len = num_read + 1;
