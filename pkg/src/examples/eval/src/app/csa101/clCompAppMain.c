...
extern ClRcT clcsa101_EOClientInstall(void);
    ...
    ClEoStateT eoState)
{
    switch (eoState)
    {
        case CL_EO_STATE_SUSPEND:
        {
            ...
            clprintf(CL_LOG_SEV_INFO, "csa101: Suspending...\n");
            running = 0;
        ...
        case CL_EO_STATE_RESUME:
        {
            ...
            clprintf(CL_LOG_SEV_INFO, "csa101: Resuming...\n");
            running = 1;
