...
extern ClRcT clExecuteSnmp (ClSnmpReqInfoT* reqInfo,
                            void* data,
                            ClInt32T *pReqInfo,
                            ClInt32T *pErrCode);
					 
extern ClRcT clRequestAdd (ClSnmpReqInfoT* reqInfo,
                            void* data,
                            ClInt32T *pReqInfo,
                            ClInt32T *pErrCode, 
                            ClPtrT pReqAddInfo);
extern ClUint32T clGetTable (ClSnmpReqInfoT* reqInfo,
							 void *data, 
							 ClInt32T *pErrCode);
					
extern ClUint32T clGetTableAttr (ClSnmpReqInfoT* reqInfo,
						void* data,
						ClInt32T *pErrCode);
						
extern ClUint32T clSnmpJobTableAttrAdd (ClSnmpReqInfoT* reqInfo,
						void* data, 
						ClInt32T *pOpNum,
						ClInt32T *pErrCode,
                        ClPtrT  pOpAddInfo);
...
extern void clSnmpOidCpy(ClSnmpReqInfoT * pReqInfo, ClWordT * pOid);
