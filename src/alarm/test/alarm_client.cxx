...
int main(int argc, char* argv[])
{
  ...
  logSeverity = SAFplus::LOG_SEV_INFO;
  sic.iocPort = 50;
  ...
  clTestGroupInitialize(("Alarm TestSuite: Basic c++ Alarm test"));
  //testSummary();
  //testAllFeature();
  //tressTest(1);
...
void raiseclear_AllAlarm()
{
  ...
  if (nullptr != appAlarms)
  {
    ...
    while (true)
    {
      ...
      g_isCallBack = false;
      raiseAlarm_Assert(indexProfile);
      clTest(("TC00:expect alarm raised"),g_isCallBack==true , ("g_isCallBack is %d", g_isCallBack));
      raiseAlarm_Clear(indexProfile);
      indexProfile++;
    } //while
  } //if
}
...
void unit_test_Raise_Alarm()
{
    ...
    clTest(("TC02:expect alarm raised for test_Clear_Soaking_Time()"),g_isCallBack==true , ("g_isCallBack is %d", g_isCallBack));
    //tc3
    ...
    clTest(("TC05:expect alarm raised for test_Assert_Lower_Clear_Soaking_Time_OR()"),g_isCallBack==true , ("g_isCallBack is %d", g_isCallBack));
    //tc6
    test_Assert_Greater_Clear_Soaking_Time_OR();
    clTest(("TC06:expect alarm raised for test_Assert_Greater_Clear_Soaking_Time_OR()"),g_isCallBack==true , ("g_isCallBack is %d", g_isCallBack));
    //tc7
    test_Assert_Raise_Clear_Soaking_Time_OR();
    clTest(("TC07:expect alarm raised for test_Assert_Raise_Clear_Soaking_Time_OR()"),g_isCallBack==false , ("g_isCallBack is %d", g_isCallBack));
    //tc8
    test_Assert_Clear_Soaking_Time_Suppression_AND();
    clTest(("TC08:expect alarm raised for test_Assert_Clear_Soaking_Time_Suppression_AND()"),g_isCallBack==true , ("g_isCallBack is %d", g_isCallBack));
    //tc9
    ...
    clTest(("TC10:expect alarm raised for test_Assert_Clear_Soaking_Time_Suppression_AND_10()"),g_isCallBack==false , ("g_isCallBack is %d", g_isCallBack));
}
/*
 * test case 11
