...
typedef  boost::intrusive::list<EventSubscriber, member_hook<EventSubscriber, list_member_hook<>, &EventSubscriber::m_memberHook>> EventSubscriberList;
typedef  boost::intrusive::list<EventPublisher, member_hook<EventPublisher, list_member_hook<>, &EventPublisher::m_memberHook>> EventPublisherList;
...
typedef  boost::intrusive::list<EventChannel, member_hook<EventChannel, list_member_hook<>, &EventChannel::m_memberHook>> EventChannelList;
