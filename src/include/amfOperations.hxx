...
namespace SAFplus
  ...
  public:  // Public API
    ...
    void quiescedOperation(SAFplusAmf::ServiceUnit* su, Wakeable& w = *((Wakeable*)nullptr));
    void quiescingOperation(SAFplusAmf::ServiceUnit* su, Wakeable& w = *((Wakeable*)nullptr));
