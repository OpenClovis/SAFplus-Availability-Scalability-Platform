...
namespace FaultEnums
  {
    ...
    enum class FaultMessageType
      {
        MSG_UNDEFINED, MSG_ENTITY_JOIN, MSG_ENTITY_LEAVE, MSG_ENTITY_FAULT, MSG_ENTITY_STATE_CHANGE, MSG_ENTITY_JOIN_BROADCAST, MSG_ENTITY_LEAVE_BROADCAST, MSG_ENTITY_FAULT_BROADCAST, MSG_ENTITY_STATE_CHANGE_BROADCAST, MSG_ENTITY_COUNT
      };
