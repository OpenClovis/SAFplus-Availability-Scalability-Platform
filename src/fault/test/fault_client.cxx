...
void testAllFeature()
{
    ...
    faultData.alarmState = FaultEnums::FaultAlarmState::ALARM_STATE_INVALID;
    faultData.category = FaultEnums::AlarmCategory::ALARM_CATEGORY_COMMUNICATIONS;
    faultData.cause = FaultEnums::FaultProbableCause::ALARM_PROB_CAUSE_PROCESSOR_PROBLEM;
    faultData.severity = FaultEnums::FaultSeverity::ALARM_SEVERITY_MINOR;
