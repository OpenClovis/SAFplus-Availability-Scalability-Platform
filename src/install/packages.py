...
class OS:
    ...
    def load_install_deps(self):
        ...
        #else:
        self.dep_list = [openhpi, netsnmp, openhpisubagent, TIPC, TIPC_CONFIG, JRE, ECLIPSE, EMF, GEF, CDT, sqlite]
        #self.dep_list = [gcc, glibc, glib, openhpi, netsnmp, openhpisubagent, JRE, ECLIPSE, EMF, GEF, CDT, sqlite]        
...
class RedHat9(OS):
    ...
    def load_preinstall_deps(self):
        ...
        'libdb-devel', 'gdbm-devel', 'sqlite-devel', 'gtk2-devel.x86_64','cups','cups-printerapp.x86_64']
