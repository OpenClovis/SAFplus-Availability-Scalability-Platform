...
static ClUint8T mSendProtoId ;
static ClUint8T mReceiveProtoId;
int numTimes=10;
...
void *SendIocMsg(void *unused)
{
	...
	while(1)
	{
		sendIocLoop(iocCommPortSend,mSendProtoId,'P');
		sleep(10);
	}
    return NULL;
}
                   ...
                   SaAmfCSIDescriptorT csiDescriptor)
{
    ...
    switch ( haState )
    {
        ...
        case SA_AMF_HA_ACTIVE:
        {
        	...
        	clprintf (CL_LOG_SEV_INFO,"successful to create a commport ");
        	//initializeIoc(CL_IOC_USER_PROTO_START + 1, CL_IOC_USER_PROTO_START + 2);
        	mSendProtoId = CL_IOC_USER_PROTO_START + 1;
        	mReceiveProtoId= CL_IOC_USER_PROTO_START + 2;
