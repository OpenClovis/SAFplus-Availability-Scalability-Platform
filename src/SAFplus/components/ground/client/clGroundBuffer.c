...
/*Wondering if this could be shoved inside clCommon.h*/
#define CL_WEAK __attribute__((weak))
ClRcT clBufferInitialize(const ClPtrT pConfig) CL_WEAK;
ClRcT clBufferFinalize(void) CL_WEAK;
