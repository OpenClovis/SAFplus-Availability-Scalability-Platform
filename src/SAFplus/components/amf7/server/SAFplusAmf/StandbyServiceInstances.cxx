...
namespace SAFplusAmf
  {
    ...
    MGT_REGISTER_IMPL(StandbyServiceInstances, /SAFplusAmf/ServiceUnit/standbyServiceInstances)

    StandbyServiceInstances::StandbyServiceInstances(): SAFplus::ClMgtObject("standbyServiceInstances")
    {
    };
