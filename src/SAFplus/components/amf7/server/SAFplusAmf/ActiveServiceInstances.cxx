...
namespace SAFplusAmf {
    ...
    vector<string> *ActiveServiceInstances::getChildNames() {
     ...
     */
    vector<unsigned long int> ActiveServiceInstances::getHistory10sec() {
     ...
     */
    vector<unsigned long int> ActiveServiceInstances::getHistory1min() {
     ...
     */
    vector<unsigned long int> ActiveServiceInstances::getHistory10min() {
     ...
     */
    vector<unsigned long int> ActiveServiceInstances::getHistory1hour() {
     ...
     */
    vector<unsigned long int> ActiveServiceInstances::getHistory12hour() {
     ...
     */
    vector<unsigned long int> ActiveServiceInstances::getHistory1day() {
     ...
     */
    vector<unsigned long int> ActiveServiceInstances::getHistory1week() {
     ...
     */
    vector<unsigned long int> ActiveServiceInstances::getHistory1month() {
