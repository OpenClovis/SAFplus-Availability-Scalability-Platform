...
/**
 * \brief Optional call to specify application-specific customization 
 *
 * \param clEoConfig pointer to your EO configuration data structure
 * \param basicLibs  List of libraries to initialize
 * \param clientLibs List of libraries to initialize

 * \par Description:
 * SAFplus used to contain a reverse dependency on certain global variables that
 * are auto-generated by the IDE.  This dependency has been removed by adding
 * this function where the application can overide the default configuration
 * for these variables.
 *
 * \sa ClEoConfigT
 */
