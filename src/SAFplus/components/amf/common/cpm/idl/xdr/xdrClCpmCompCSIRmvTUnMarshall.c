...
*********************************************************************/
/*********************************************************************
* Description : Unmarshall routine for ClCpmCompCSIRmvT
*     
...
ClRcT clXdrUnmarshallClCpmCompCSIRmvT_4_0_0(ClBufferHandleT msg , void* pGenVar)
{
    ...
    rc = clXdrUnmarshallClUint32T(msg,&(pVar->csiFlags));
    if (CL_OK != rc)
    {
        return rc;
    }
