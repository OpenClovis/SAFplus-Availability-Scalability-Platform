...
*********************************************************************/
/*********************************************************************
* Description : Marshall routine for ClCpmCompCSIRmvT
*     
...
ClRcT clXdrMarshallClCpmCompCSIRmvT_4_0_0(void* pGenVar, ClBufferHandleT msg, ClUint32T isDelete)
{
    ClCpmCompCSIRmvT_4_0_0* pVar = (ClCpmCompCSIRmvT_4_0_0*)pGenVar;
    ClRcT rc         = CL_OK;
    ClUint32T length = 0;    
    ...
    rc = clXdrMarshallClUint32T(&(pVar->csiFlags),msg,isDelete);
    if (CL_OK != rc)
    {
        return rc;
    }
