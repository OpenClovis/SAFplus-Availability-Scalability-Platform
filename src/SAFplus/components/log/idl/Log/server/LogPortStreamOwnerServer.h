...
ClRcT clLogStreamOwnerStreamClose_4_0_0(CL_IN SaNameT*  pStreamName, CL_IN ClLogStreamScopeT  pStreamScope, CL_IN SaNameT*  pStreamScopeNode, CL_IN ClUint32T  nodeAddress, CL_IN ClUint32T  compId);

ClRcT clLogStreamOwnerStreamCloseResponseSend_4_0_0(CL_IN ClIdlHandleT idlHdl,CL_IN ClRcT retCode);

ClRcT clLogStreamOwnerFilterSet_4_0_0(CL_IN SaNameT*  pStreamName, CL_IN ClLogStreamScopeT  pStreamScope, CL_IN SaNameT*  pStreamScopeNode, CL_IN ClUint8T  filterFlags, CL_IN ClLogFilterT_4_0_0*  pFilter);

ClRcT clLogStreamOwnerFilterSetResponseSend_4_0_0(CL_IN ClIdlHandleT idlHdl,CL_IN ClRcT retCode);

ClRcT clLogStreamOwnerHandlerRegister_4_0_0(CL_IN SaNameT*  pStreamName, CL_IN ClLogStreamScopeT  pStreamScope, CL_IN SaNameT*  pStreamScopeNode, CL_IN ClUint8T  handlerFlags, CL_IN ClUint32T  localAddr, CL_IN ClUint32T  compId);

ClRcT clLogStreamOwnerHandlerRegisterResponseSend_4_0_0(CL_IN ClIdlHandleT idlHdl,CL_IN ClRcT retCode);

ClRcT clLogStreamOwnerStreamMcastGet_4_0_0(CL_IN SaNameT*  pStreamName, CL_IN ClLogStreamScopeT  pStreamScope, CL_IN SaNameT*  pStreamScopeNode, CL_OUT ClUint64T*  mcastAddr);
...
ClRcT clLogStreamOwnerHandlerDeregister_4_0_0(CL_IN SaNameT*  pStreamName, CL_IN ClLogStreamScopeT  pStreamScope, CL_IN SaNameT*  pStreamScopeNode, CL_IN ClUint8T  handlerFlags, CL_IN ClUint32T  localAddr, CL_IN ClUint32T  compId);

ClRcT clLogStreamOwnerHandlerDeregisterResponseSend_4_0_0(CL_IN ClIdlHandleT idlHdl,CL_IN ClRcT retCode);

ClRcT clLogStreamOwnerFilterGet_4_0_0(CL_IN SaNameT*  pStreamName, CL_IN ClLogStreamScopeT  pStreamScope, CL_IN SaNameT*  pStreamScopeNode, CL_OUT ClLogFilterT_4_0_0*  pFilter);
