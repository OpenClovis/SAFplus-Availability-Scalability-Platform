...
int main(int argc, char* argv[])
{
  ...
  static ClTimerTimeOutT testTimeout = { .tsSec = 35, .tsMilliSec = 0 };
  Timer timerTest1(testTimeout, CL_TIMER_ONE_SHOT, CL_TIMER_SEPARATE_CONTEXT,testTimerCallback1, NULL);
  Timer timerTest2(testTimeout, CL_TIMER_ONE_SHOT, CL_TIMER_SEPARATE_CONTEXT,testTimerCallback2, NULL);
  Timer timerTest3(testTimeout, CL_TIMER_ONE_SHOT, CL_TIMER_SEPARATE_CONTEXT,testTimerCallback3, NULL);
  Timer timerTest4(testTimeout, CL_TIMER_ONE_SHOT, CL_TIMER_SEPARATE_CONTEXT,testTimerCallback4, NULL);
  Timer timerTest5(testTimeout, CL_TIMER_ONE_SHOT, CL_TIMER_SEPARATE_CONTEXT,testTimerCallback5, NULL);
  Timer timerTest6(testTimeout, CL_TIMER_REPETITIVE, CL_TIMER_SEPARATE_CONTEXT,testTimerCallback6, NULL);
  Timer timerTest7(testTimeout, CL_TIMER_REPETITIVE, CL_TIMER_SEPARATE_CONTEXT,testTimerCallback7, NULL);
  Timer timerTest8(testTimeout, CL_TIMER_REPETITIVE, CL_TIMER_SEPARATE_CONTEXT,testTimerCallback8, NULL);
  Timer timerTest9(testTimeout, CL_TIMER_REPETITIVE, CL_TIMER_SEPARATE_CONTEXT,testTimerCallback9, NULL);
  Timer timerTest10(testTimeout, CL_TIMER_REPETITIVE, CL_TIMER_SEPARATE_CONTEXT,testTimerCallback10, NULL);
  Timer timerTest11(testTimeout, CL_TIMER_REPETITIVE, CL_TIMER_SEPARATE_CONTEXT,testTimerCallback11, NULL);
  Timer timerTest12(testTimeout, CL_TIMER_REPETITIVE, CL_TIMER_SEPARATE_CONTEXT,testTimerCallback12, NULL);
  Timer timerTest13(testTimeout, CL_TIMER_REPETITIVE, CL_TIMER_SEPARATE_CONTEXT,testTimerCallback13, NULL);
  Timer timerTest14(testTimeout, CL_TIMER_REPETITIVE, CL_TIMER_SEPARATE_CONTEXT,testTimerCallback14, NULL);
  Timer timerTest15(testTimeout, CL_TIMER_REPETITIVE, CL_TIMER_SEPARATE_CONTEXT,testTimerCallback15, NULL);
  Timer timerTest16(testTimeout, CL_TIMER_REPETITIVE, CL_TIMER_SEPARATE_CONTEXT,testTimerCallback16, NULL);
  Timer *timerTest17= new Timer(testTimeout, CL_TIMER_REPETITIVE, CL_TIMER_SEPARATE_CONTEXT,testTimerCallback17, NULL);
  Timer timerTest18(testTimeout, CL_TIMER_REPETITIVE, CL_TIMER_SEPARATE_CONTEXT,testTimerCallback18, NULL);
  Timer timerTest19(testTimeout, CL_TIMER_REPETITIVE, CL_TIMER_SEPARATE_CONTEXT,testTimerCallback19, NULL);
  Timer timerTest20(testTimeout, CL_TIMER_REPETITIVE, CL_TIMER_SEPARATE_CONTEXT,testTimerCallback20, NULL);
  Timer timerTest21(testTimeout, CL_TIMER_REPETITIVE, CL_TIMER_SEPARATE_CONTEXT,testTimerCallback21, NULL);
  Timer timerTest22(testTimeout, CL_TIMER_REPETITIVE, CL_TIMER_SEPARATE_CONTEXT,testTimerCallback22, NULL);
  Timer timerTest23(testTimeout, CL_TIMER_REPETITIVE, CL_TIMER_SEPARATE_CONTEXT,testTimerCallback23, NULL);
