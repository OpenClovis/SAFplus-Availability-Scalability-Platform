...
ClRcT clMsgQueueOpen_4_0_0(CL_IN ClNameT*  pQueueName, CL_IN SaMsgQueueCreationAttributesT_4_0_0*  pCreationAttributes, CL_IN SaMsgQueueOpenFlagsT_4_0_0  openFlags);

ClRcT clMsgQueueOpenResponseSend_4_0_0(CL_IN ClIdlHandleT idlHdl,CL_IN ClRcT retCode);

ClRcT clMsgQueueRetentionClose_4_0_0(CL_IN ClNameT*  pQueueName);

ClRcT clMsgQueueRetentionCloseResponseSend_4_0_0(CL_IN ClIdlHandleT idlHdl,CL_IN ClRcT retCode);

ClRcT clMsgQueuePersistRedundancy_4_0_0(CL_IN ClNameT*  queue, CL_IN ClIocPhysicalAddressT_4_0_0  srcAddr, CL_IN ClUint16T  qDelete);
