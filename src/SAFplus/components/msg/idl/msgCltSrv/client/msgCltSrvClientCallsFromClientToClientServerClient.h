...
typedef void (*MsgCltSrvClMsgMessageReceivedAsyncCallbackT_4_0_0) (CL_IN ClIdlHandleT handle, CL_IN ClUint32T  sendType, CL_IN ClNameT* pDestination, CL_IN ClMsgMessageIovecT_4_0_0* pMessage, CL_IN ClInt64T  sendTime, CL_IN ClHandleT  senderHandle, CL_IN ClInt64T  timeout, CL_IN ClRcT rc, CL_IN void* pCookie);
