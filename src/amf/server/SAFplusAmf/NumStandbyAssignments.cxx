/* 
 * File NumStandbyAssignments.cxx
...
namespace SAFplusAmf
  {
    ...
    MGT_REGISTER_IMPL(NumStandbyAssignments, /SAFplusAmf/ServiceInstance/numStandbyAssignments)

    NumStandbyAssignments::NumStandbyAssignments()
    {
        this->tag.assign("numStandbyAssignments");
    };

    std::vector<std::string>* NumStandbyAssignments::getChildNames()
    {
