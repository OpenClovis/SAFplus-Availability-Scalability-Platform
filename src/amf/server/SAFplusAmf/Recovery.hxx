...
namespace SAFplusAmf
  {
    ...
    enum class Recovery
      {
        None=0,NoRecommendation=1, CompRestart=2, CompFailover=3, NodeSwitchover=4, NodeFailover=5, NodeFailfast=6, ClusterReset=7, ApplicationRestart=8, ContainerRestart=9, SuRestart=10
      };
