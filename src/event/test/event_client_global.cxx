...
int main(int argc, char* argv[])
{
    ...
    fc.eventChannelSubscriber(TEST_EVENT_CHANNEL_NAME, EventChannelScope::EVENT_GLOBAL_CHANNEL);
    testAllFeature();
    ...
    fc.eventChannelUnSubscriber(TEST_EVENT_CHANNEL_NAME, EventChannelScope::EVENT_GLOBAL_CHANNEL);
...
void testAllFeature()
{
  ...
  fc.eventPublish(testdata,testdata.length(),TEST_EVENT_CHANNEL_NAME,EventChannelScope::EVENT_GLOBAL_CHANNEL);
}
