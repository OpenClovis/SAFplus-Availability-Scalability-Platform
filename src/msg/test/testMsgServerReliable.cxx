...
bool testSendRecv()
  {
  MsgServer a(2,10,2,SAFplus::MsgServer::Options::DEFAULT_OPTIONS,SAFplus::MsgServer::SocketType::SOCK_RELIABLE);
  MsgServer b(1,10,2,SAFplus::MsgServer::Options::DEFAULT_OPTIONS,SAFplus::MsgServer::SocketType::SOCK_RELIABLE);
 
  const char* strMsg = "This is a test of message sending";
  const char* strMsg1 = "This is a test of message sending bidirectional";
  ...
  a.Start();
  b.SendMsg(a.handle,(void*) strMsg1,strlen(strMsg1),1);
  a_receiver.lock();
  printf("Message was : %s\n",a_receiver.data);
