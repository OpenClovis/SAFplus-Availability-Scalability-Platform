...
class test(testcase.TestGroup):
    ...
    def test_udp3(self):
        ...
        self.progTest(self.model.cfg.mapping.SysCtrl0.installDir + "/test/testMsgServer --xport=clMsgUdp.so --mode=LAN --duration=15000",120)  # An App Test just starts running its tests when started (there is no addtl trigger required to put the entity "in service", etc.  The parameter is how long to wait before assuming the test hung.
        self.assert_equal(1, 1, 'This test always works')
    ...
    def test_udp4(self):
        ...
        """
        self.progTest(self.model.cfg.mapping.SysCtrl0.installDir + "/test/testMsgServer --xport=clMsgUdp.so --mode=cloud --duration=15000",120)
        self.assert_equal(1, 1, 'This test always works')
    ...
    def test_sctp3(self):
        ...
        self.progTest(self.model.cfg.mapping.SysCtrl0.installDir + "/test/testMsgServer --xport=clMsgSctp.so --mode=LAN --duration=15000",120)  # An App Test just starts running its tests when started (there is no addtl trigger required to put the entity "in service", etc.  The parameter is how long to wait before assuming the test hung.
        self.assert_equal(1, 1, 'This test always works')
    ...
    def test_sctp4(self):
        ...
        """
        self.progTest(self.model.cfg.mapping.SysCtrl0.installDir + "/test/testMsgServer --xport=clMsgSctp.so --mode=cloud --duration=15000",120)
        self.assert_equal(1, 1, 'This test always works')
    ...
    def xxxtest_TCP3(self): # TCP LAN makes no sense (no broadcast so you need the node list)
        ...
        self.progTest(self.model.cfg.mapping.SysCtrl0.installDir + "/test/testMsgServer --loglevel=error --xport=clMsgTcp.so --mode=LAN --duration=15000",120)  # An App Test just starts running its tests when started (there is no addtl trigger required to put the entity "in service", etc.  The parameter is how long to wait before assuming the test hung.
        self.assert_equal(1, 1, 'This test always works')
    ...
    def test_TCP4(self):
        ...
        """
        self.progTest(self.model.cfg.mapping.SysCtrl0.installDir + "/test/testMsgServer --loglevel=error --xport=clMsgTcp.so --mode=cloud --duration=15000",120)
        self.assert_equal(1, 1, 'This test always works')
    ...
    def test_TPC3(self):
        ...
        self.progTest(self.model.cfg.mapping.SysCtrl0.installDir + "/test/testMsgServer --xport=clMsgTipc.so --mode=LAN --duration=15000",120)  # An App Test just starts running its tests when started (there is no addtl trigger required to put the entity "in service", etc.  The parameter is how long to wait before assuming the test hung.
        self.assert_equal(1, 1, 'This test always works')
    ...
    def test_TPC4(self):
        ...
        """
        self.progTest(self.model.cfg.mapping.SysCtrl0.installDir + "/test/testMsgServer --xport=clMsgTipc.so --mode=cloud --duration=15000",120)
        self.assert_equal(1, 1, 'This test always works')
