...
import time
import getpass
from templates import fmTemplate
...
#------------------------------------------------------------------------------
#------------------------------------------------------------------------------
def createFaultRepairHandles(srcDir, resList):
	faultRepairEntries = ""
	...
	out_file = open (os.path.join(srcDir, "config/clFaultRepairHandlers.c"), "w")
...
def mainMethod(srcDir, buildConfigsDoc, resourceDoc):
	...
	faultCfgFile = os.path.join(srcDir, "config/clFaultCfg.c")
	out_file = open(faultCfgFile,"w")
	...
	if(methodSkeletons != ""):	
		out_file = open (os.path.join(srcDir, "config/clFaultReportHandlers.c"), "w")
	...
	createFaultRepairHandles(srcDir, resourceList)
