...
ClRcT clamfMgmtSAAMFHEALTHCHECKTABLEProvConstructor( void *pThis, void *pUsrData, ClUint32T usrDataLen )
{
	...
	((CL_OM_PROV_CLASS*)pThis)->clProvObjectValidate = clamfMgmtSAAMFHEALTHCHECKTABLEProvObjectValidate; 	 
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectUpdate = clamfMgmtSAAMFHEALTHCHECKTABLEProvObjectUpdate; 	 
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectRollback = clamfMgmtSAAMFHEALTHCHECKTABLEProvObjectRollback;
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectRead = clamfMgmtSAAMFHEALTHCHECKTABLEProvObjectRead;
 ...
 * Please refer protptype of this function in the file clamfMgmtSAAMFHEALTHCHECKTABLEOAMPConfig.h
