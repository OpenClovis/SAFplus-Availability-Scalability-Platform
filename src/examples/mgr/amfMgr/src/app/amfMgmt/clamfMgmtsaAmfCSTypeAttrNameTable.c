/******************************************************************************
 *
 * clamfMgmtsaAmfCSTypeAttrNameTable.c
 *
 ******************************************************************************
...
ClRcT clamfMgmtSAAMFCSTYPEATTRNAMETABLEProvConstructor( void *pThis, void *pUsrData, ClUint32T usrDataLen )
{
    ...
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectStart = clamfMgmtSAAMFCSTYPEATTRNAMETABLEProvObjectStart;      
    ((CL_OM_PROV_CLASS*)pThis)->clProvValidate = (fp)clamfMgmtSAAMFCSTYPEATTRNAMETABLEProvValidate;    
    ((CL_OM_PROV_CLASS*)pThis)->clProvUpdate = (fp)clamfMgmtSAAMFCSTYPEATTRNAMETABLEProvUpdate;    
    ((CL_OM_PROV_CLASS*)pThis)->clProvRollback = (fp)clamfMgmtSAAMFCSTYPEATTRNAMETABLEProvRollback;
    ((CL_OM_PROV_CLASS*)pThis)->clProvRead = (fp)clamfMgmtSAAMFCSTYPEATTRNAMETABLEProvRead;
	((CL_OM_PROV_CLASS*)pThis)->clProvObjectValidate = clamfMgmtSAAMFCSTYPEATTRNAMETABLEProvObjectValidate; 	 
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectUpdate = clamfMgmtSAAMFCSTYPEATTRNAMETABLEProvObjectUpdate; 	 
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectRollback = clamfMgmtSAAMFCSTYPEATTRNAMETABLEProvObjectRollback;
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectRead = clamfMgmtSAAMFCSTYPEATTRNAMETABLEProvObjectRead;
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectEnd = clamfMgmtSAAMFCSTYPEATTRNAMETABLEProvObjectEnd;      
 ...
 * clamfMgmtSAAMFCSTYPEATTRNAMETABLEOAMPConfig.h for detailed documentation for this function.
 */
 ...
 * Please refer protptype of this function in the file clamfMgmtSAAMFCSTYPEATTRNAMETABLEOAMPConfig.h
