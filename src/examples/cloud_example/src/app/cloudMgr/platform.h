...
// Check if the named app container exists
bool acExists(const char* appCnt);
...
void testCreateWork(const char *work, const char *node1, const char *node2, bool createNode = false);

void testRemoveWork(const char *work, const char *node1, const char *node2);
