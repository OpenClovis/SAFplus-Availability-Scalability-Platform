...
def clean_rtXml(srcDir, nodeInstanceList):
...
def mainMethod(srcDir, amfConfigXml, componentXml):
	...
	if os.path.exists(amfConfigXml):
		...
		clean_rtXml(srcDir, nodeInstanceList)##call even if the list doesn't have any element
