...
ClRcT clProvisioningTIMESETTABLEProvConstructor( void *pThis, void *pUsrData, ClUint32T usrDataLen )
{
	...
	((CL_OM_PROV_CLASS*)pThis)->clProvObjectValidate = clProvisioningTIMESETTABLEProvObjectValidate; 	 
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectUpdate = clProvisioningTIMESETTABLEProvObjectUpdate; 	 
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectRollback = clProvisioningTIMESETTABLEProvObjectRollback;
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectRead = clProvisioningTIMESETTABLEProvObjectRead;
