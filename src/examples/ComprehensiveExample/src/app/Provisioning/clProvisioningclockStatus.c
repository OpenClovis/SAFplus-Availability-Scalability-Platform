...
ClRcT clProvisioningCLOCKSTATUSProvConstructor( void *pThis, void *pUsrData, ClUint32T usrDataLen )
{
    ...
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectStart = clProvisioningCLOCKSTATUSProvObjectStart;      
    ((CL_OM_PROV_CLASS*)pThis)->clProvValidate = (fp)clProvisioningCLOCKSTATUSProvValidate;    
    ((CL_OM_PROV_CLASS*)pThis)->clProvUpdate = (fp)clProvisioningCLOCKSTATUSProvUpdate;    
    ((CL_OM_PROV_CLASS*)pThis)->clProvRollback = (fp)clProvisioningCLOCKSTATUSProvRollback;
    ((CL_OM_PROV_CLASS*)pThis)->clProvRead = (fp)clProvisioningCLOCKSTATUSProvRead;
	((CL_OM_PROV_CLASS*)pThis)->clProvObjectValidate = clProvisioningCLOCKSTATUSProvObjectValidate; 	 
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectUpdate = clProvisioningCLOCKSTATUSProvObjectUpdate; 	 
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectRollback = clProvisioningCLOCKSTATUSProvObjectRollback;
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectRead = clProvisioningCLOCKSTATUSProvObjectRead;
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectEnd = clProvisioningCLOCKSTATUSProvObjectEnd;      
 ...
 * clProvisioningCLOCKSTATUSOAMPConfig.h for detailed documentation for this function.
 */
 ...
 * Please refer protptype of this function in the file clProvisioningCLOCKSTATUSOAMPConfig.h
