 ...
 *  it returns success then the cl${compName}${res}ProvObjectUpdate() will be
 *  called otherwise cl${compName}${res}ProvObjectRollback() is called for
 *  rolling the jobs back.
 *
 *  \sa
 *  cl${compName}${res}ProvObjectUpdate, cl${compName}${res}ProvObjectRollback
 */
ClRcT cl${compName}${res}ProvObjectValidate(CL_OM_PROV_CLASS* pThis, ClHandleT txnHandle, ClProvTxnDataT* pProvTxnDataList, ClUint32T txnDataEntries);
 ...
 *
 *  \sa
 *  cl${compName}${res}ProvObjectValidate
 */
ClRcT cl${compName}${res}ProvObjectUpdate(CL_OM_PROV_CLASS* pThis, ClHandleT txnHandle, ClProvTxnDataT* pProvTxnDataList, ClUint32T txnDataEntries);
 ...
 *  cl${compName}${res}ProvObjectValidate
 */
ClRcT cl${compName}${res}ProvObjectRollback(CL_OM_PROV_CLASS* pThis, ClHandleT txnHandle, ClProvTxnDataT* pProvTxnDataList, ClUint32T txnDataEntries);
 ...
 */
ClRcT cl${compName}${res}ProvObjectRead(CL_OM_PROV_CLASS* pThis, ClHandleT txnHandle, ClProvTxnDataT* pProvTxnDataList, ClUint32T txnDataEntries);
...
ClRcT cl${compName}${res}ProvConstructor( void *pThis, void *pUsrData, ClUint32T usrDataLen )
{
	...
	((CL_OM_PROV_CLASS*)pThis)->clProvObjectValidate = cl${compName}${res}ProvObjectValidate; 	 
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectUpdate = cl${compName}${res}ProvObjectUpdate; 	 
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectRollback = cl${compName}${res}ProvObjectRollback;
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectRead = cl${compName}${res}ProvObjectRead;
 ...
 * Please refer protptype of this function in the file cl${compName}${res}OAMPConfig.h
