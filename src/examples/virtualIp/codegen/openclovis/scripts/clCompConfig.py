...
def processComponent(cmpList):
	...
	for cmp in cmpList:
		...
		symbolMap["txnClLib"]      = aspLibObj.attributes["Transaction"].value        
                ...
                # Note PROV and MSO are automatically activated if COR is
		symbolMap["provLib"]       = aspLibObj.attributes["COR"].value
		symbolMap["msoLib"]        = aspLibObj.attributes["COR"].value
