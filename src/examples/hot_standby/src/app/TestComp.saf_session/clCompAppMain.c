 ...
 */
 ...
 SaCkptHandleT   alarmClockCkptHdl = 0;
 ...
 *****************************************************************************/
static void __sessionFinalize(void)
{
#if 1
    sessionFinalize();
#else
    if(alarmClockCkptHdl)
        alarmClockCkptSessionFinalize(alarmClockCkptHdl, 1);
#endif
}
    ...
    case SA_AMF_HA_ACTIVE:
        {
            ...
            {       
                ...
                rc = alarmClockCkptRead ( alarmClockCkptHdl, 1, NULL, 0);
            }
            alarmClockStart();
            prevHaState = haState;
            saAmfResponse(amfHandle, invocation, SA_AIS_OK);
    ...
    case SA_AMF_HA_STANDBY:
        {
            ...
            prevHaState = haState;
            alarmClockCkptHotStandbyRegister(alarmClockCkptHdl);
            alarmClockCkptRead(alarmClockCkptHdl, 1, NULL, 0);
            saAmfResponse(amfHandle, invocation, SA_AIS_OK);
            break;
        }
    ...
    case SA_AMF_HA_QUIESCED:
        {
             ...
             */
            alarmClockCkptHotStandbyDeregister(alarmClockCkptHdl);
            alarmClockStop();
            prevHaState = haState;
            __sessionFinalize();
            saAmfResponse(amfHandle, invocation, SA_AIS_OK);
