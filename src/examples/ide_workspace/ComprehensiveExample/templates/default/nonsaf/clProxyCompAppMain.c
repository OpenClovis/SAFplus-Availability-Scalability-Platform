    ...
    ClCharT *argv[])
{
    ...
    callbacks.appProxiedComponentInstantiate    = clProxiedCompInstantiate;
    callbacks.appProxiedComponentCleanup        = clProxiedCompCleanup;
    ...
    const ClNameT       *compName)
{
    ...
    /*
     * Needs to call CPM client finalize only in case the termination request 
     * was for the proxy component.
     */
    ...
    const ClNameT       *proxiedCompName)
{
    ...
    if ( (rc = clCpmComponentNameGet(cpmHandle, &appName)) ) 
        goto errorexit;
    if ( (rc = clCpmComponentRegister(cpmHandle, proxiedCompName, &appName)) ) 
        goto errorexit;
