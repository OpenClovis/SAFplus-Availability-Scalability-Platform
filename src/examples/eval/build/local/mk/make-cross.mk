...
export PROJECT_ROOT=/code/git/SAFplus/src/examples/ide_workspace
export ASP_INSTALLDIR=/opt/clovis/sdk-6.0
export CL_TARGET_OS=linux-3.5.7
export CL_TARGET_PLATFORM=x86_64
export CM_BUILD=0
export SNMP_BUILD=0
export OPENHPILIBS=-L/opt/clovis/buildtools/local/lib -Xlinker -rpath-link -Xlinker /opt/clovis/buildtools/local/lib -lopenhpi -lopenhpiutils -lglib-2.0
export OPENHPICFLAGS=-I/opt/clovis/buildtools/local/include/openhpi -I/opt/clovis/buildtools/local/include/glib-2.0 -I/opt/clovis/buildtools/local/lib/glib-2.0/include 
export ASP_VERSION=6.0
export BUILD_TIPC=1
export TIPC_INC_DIR=include/net/tipc
export TARGET_QNX=0
...
export MODEL_TARGET=$(PROJECT_ROOT)/$(ASP_MODEL_NAME)/target/x86_64/linux-3.5.7
