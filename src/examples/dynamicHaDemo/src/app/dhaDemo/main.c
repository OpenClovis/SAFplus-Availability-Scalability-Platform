...
ClRcT clDhaDemoStart(void)
{

    ClRcT  rc = CL_OK;


    rc = clOsalTaskCreateDetached("dhaDemoCreate", CL_OSAL_SCHED_OTHER, CL_OSAL_THREAD_PRI_NOT_APPLICABLE, CL_OSAL_MIN_STACK_SIZE, clDhaDemoCreate, NULL);
        
    return rc;

}

ClRcT clDhaDemoStop(void)
{

    ClRcT  rc = CL_OK;


    rc = clOsalTaskCreateDetached("dhaDemoDelete", CL_OSAL_SCHED_OTHER, CL_OSAL_THREAD_PRI_NOT_APPLICABLE, CL_OSAL_MIN_STACK_SIZE, clDhaDemoDelete, NULL);
