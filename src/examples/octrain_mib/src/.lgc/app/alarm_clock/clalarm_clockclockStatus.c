...
ClRcT clalarm_clockCLOCKSTATUSProvConstructor( void *pThis, void *pUsrData, ClUint32T usrDataLen )
{
    ...
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectStart = clalarm_clockCLOCKSTATUSProvObjectStart;      
    ((CL_OM_PROV_CLASS*)pThis)->clProvValidate = (fp)clalarm_clockCLOCKSTATUSProvValidate;    
    ((CL_OM_PROV_CLASS*)pThis)->clProvUpdate = (fp)clalarm_clockCLOCKSTATUSProvUpdate;    
    ((CL_OM_PROV_CLASS*)pThis)->clProvRollback = (fp)clalarm_clockCLOCKSTATUSProvRollback;
    ((CL_OM_PROV_CLASS*)pThis)->clProvRead = (fp)clalarm_clockCLOCKSTATUSProvRead;
	((CL_OM_PROV_CLASS*)pThis)->clProvObjectValidate = clalarm_clockCLOCKSTATUSProvObjectValidate; 	 
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectUpdate = clalarm_clockCLOCKSTATUSProvObjectUpdate; 	 
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectRollback = clalarm_clockCLOCKSTATUSProvObjectRollback;
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectRead = clalarm_clockCLOCKSTATUSProvObjectRead;
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectEnd = clalarm_clockCLOCKSTATUSProvObjectEnd;      
 ...
 * clalarm_clockCLOCKSTATUSOAMPConfig.h for detailed documentation for this function.
 */
 ...
 * Please refer protptype of this function in the file clalarm_clockCLOCKSTATUSOAMPConfig.h
