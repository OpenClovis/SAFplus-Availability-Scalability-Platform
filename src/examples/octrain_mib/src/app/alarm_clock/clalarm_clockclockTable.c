...
ClRcT clalarm_clockCLOCKTABLEProvConstructor( void *pThis, void *pUsrData, ClUint32T usrDataLen )
{
    ...
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectStart = clalarm_clockCLOCKTABLEProvObjectStart;      
    ((CL_OM_PROV_CLASS*)pThis)->clProvValidate = (fp)clalarm_clockCLOCKTABLEProvValidate;    
    ((CL_OM_PROV_CLASS*)pThis)->clProvUpdate = (fp)clalarm_clockCLOCKTABLEProvUpdate;    
    ((CL_OM_PROV_CLASS*)pThis)->clProvRollback = (fp)clalarm_clockCLOCKTABLEProvRollback;
    ((CL_OM_PROV_CLASS*)pThis)->clProvRead = (fp)clalarm_clockCLOCKTABLEProvRead;
	((CL_OM_PROV_CLASS*)pThis)->clProvObjectValidate = clalarm_clockCLOCKTABLEProvObjectValidate; 	 
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectUpdate = clalarm_clockCLOCKTABLEProvObjectUpdate; 	 
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectRollback = clalarm_clockCLOCKTABLEProvObjectRollback;
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectRead = clalarm_clockCLOCKTABLEProvObjectRead;
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectEnd = clalarm_clockCLOCKTABLEProvObjectEnd;      
 ...
 * clalarm_clockCLOCKTABLEOAMPConfig.h for detailed documentation for this function.
 */
 ...
 * Please refer protptype of this function in the file clalarm_clockCLOCKTABLEOAMPConfig.h
