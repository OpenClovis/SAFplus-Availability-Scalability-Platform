...
ClRcT clalarm_clockTIMESETTABLEProvConstructor( void *pThis, void *pUsrData, ClUint32T usrDataLen )
{
    ...
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectStart = clalarm_clockTIMESETTABLEProvObjectStart;      
    ((CL_OM_PROV_CLASS*)pThis)->clProvValidate = (fp)clalarm_clockTIMESETTABLEProvValidate;    
    ((CL_OM_PROV_CLASS*)pThis)->clProvUpdate = (fp)clalarm_clockTIMESETTABLEProvUpdate;    
    ((CL_OM_PROV_CLASS*)pThis)->clProvRollback = (fp)clalarm_clockTIMESETTABLEProvRollback;
    ((CL_OM_PROV_CLASS*)pThis)->clProvRead = (fp)clalarm_clockTIMESETTABLEProvRead;
	((CL_OM_PROV_CLASS*)pThis)->clProvObjectValidate = clalarm_clockTIMESETTABLEProvObjectValidate; 	 
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectUpdate = clalarm_clockTIMESETTABLEProvObjectUpdate; 	 
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectRollback = clalarm_clockTIMESETTABLEProvObjectRollback;
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectRead = clalarm_clockTIMESETTABLEProvObjectRead;
    ((CL_OM_PROV_CLASS*)pThis)->clProvObjectEnd = clalarm_clockTIMESETTABLEProvObjectEnd;      
 ...
 * clalarm_clockTIMESETTABLEOAMPConfig.h for detailed documentation for this function.
 */
 ...
 * Please refer protptype of this function in the file clalarm_clockTIMESETTABLEOAMPConfig.h
