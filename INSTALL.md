...
# How to install SAFplus Software Development Kit
...
the buildtools directory of the installed SDK (gotten from the Installation step above). For example, if the installed SDK is /home/<user_name>/opt/clovis/sdk-6.0, then it's /home/<user_name>/opt/clovis/buildtools/local and extract it here.
