/*******************************************************************************
 * ModuleName  : com
 * $File: //depot/dev/main/Andromeda/IDE/plugins/com.clovis.cw.editor.ca/src/com/clovis/cw/editor/ca/editpart/CSIAssignedtoEditPart.java $
 * $Author: bkpavan $
 * $Date: 2007/01/03 $
 *******************************************************************************/
...
public class CSIAssignedtoEditPart extends ProxyProxiedEditPart {
	/**
    ...
    protected IFigure createFigure()
    {
        ...
        ((PolylineConnection) connectionFigure).add(
        		new Label("is assigned to"), sourcelocator);
