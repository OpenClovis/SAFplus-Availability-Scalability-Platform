/*******************************************************************************
 * ModuleName  : com
 * $File: //depot/dev/main/Andromeda/IDE/plugins/com.clovis.cw.editor.ca/src/com/clovis/cw/editor/ca/figure/ServiceGroupFigure.java $
 * $Author: bkpavan $
 * $Date: 2007/01/03 $
 *******************************************************************************/
...
public class ServiceGroupFigure extends ShadowRoundedRectangle implements
ClassEditorConstants,ComponentEditorConstants
{
     ...
     */
    public ServiceGroupFigure(NodeModel model)
    {
        super();
        _model = model;
        ...
        setBackgroundColor(SERVICEGROUP_COLOR);
