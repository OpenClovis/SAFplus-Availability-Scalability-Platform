/*******************************************************************************
 * ModuleName  : com
 * $File: //depot/dev/main/Andromeda/IDE/plugins/com.clovis.cw.editor.ca/src/com/clovis/cw/editor/ca/figure/NodeFigure.java $
 * $Author: bkpavan $
 * $Date: 2007/01/03 $
 *******************************************************************************/
 ...
 * Figure for Node 
 */
public class NodeFigure extends ShadowRoundedRectangle implements
ClassEditorConstants, ComponentEditorConstants
{
     ...
     */
    public NodeFigure(NodeModel model)
    {
        super();
        _model = model;
