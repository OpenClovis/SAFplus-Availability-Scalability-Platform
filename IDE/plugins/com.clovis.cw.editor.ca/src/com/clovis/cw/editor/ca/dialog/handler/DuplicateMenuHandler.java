...
/**
 * Duplicate Menu Handler. This handler is used in Preference Dialog's
 * pop-up menus
 * @author Pushparaj
 *
 */
public class DuplicateMenuHandler extends AbstractMenuHandler {
	/**
