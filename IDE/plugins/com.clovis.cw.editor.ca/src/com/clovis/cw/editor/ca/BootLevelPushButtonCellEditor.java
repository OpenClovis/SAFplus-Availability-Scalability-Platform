/*******************************************************************************
 * ModuleName  : com
 * $File: //depot/dev/main/Andromeda/IDE/plugins/com.clovis.cw.editor.ca/src/com/clovis/cw/editor/ca/BootLevelPushButtonCellEditor.java $
 * $Author: bkpavan $
 * $Date: 2007/05/09 $
 *******************************************************************************/
...
public class BootLevelPushButtonCellEditor extends PushButtonCellEditor {
	 ...
	 */
	public BootLevelPushButtonCellEditor(Composite parent, EReference ref,
			Environment env) {
	...
	protected Object openDialogBox(Control cellEditorWindow) {
		...
		new BootLevelPushButtonDialog(getControl().getShell(), eobj.eContainer(), nextRef
	...
	public static CellEditor createEditor(Composite parent,
		...
		return new BootLevelPushButtonCellEditor(parent, (EReference) feature,
				env);
	}
	
	class BootLevelValidator extends DialogValidator 
	{
		private int _maxBootLevel = 5;
	     ...
	     *
	     * @param obj - Object
	     * @param bootLevel Max Boot Level
	     * @param model Model
	     *
	     */
	    public BootLevelValidator(Object obj, int bootLevel, Model model)
	    {
			this(obj, model, 2);
			_maxBootLevel = bootLevel;
	    }
	    /**
	    *
	    * @param obj -
	    ...
	    *
	    */
	   public BootLevelValidator(Object obj, Model model, int depth)
	   {
	   ...
	   public void setMessage(String message)
	   {
		...
		{
			String message = null;
			int bootLevel = Integer.parseInt(obj.eGet(
					obj.eClass().getEStructuralFeature("level"))
					.toString());
			if (bootLevel < 6) {
				setValid(false);
				message = "bootLevel should be > default bootlevel(5)";
			} else if (bootLevel > _maxBootLevel) {
				setValid(false);
				message = "bootLevel should be <= "
						+ "maximum bootLevel(" + _maxBootLevel +")";
			}
			return message;
		}
		/**
	    ...
	    public void notifyChanged(Notification notification)
	    {
	        ...
	        case Notification.SET:
				...
				if (notification.getNotifier() instanceof EObject) {
					...
					int bootLevel = Integer.parseInt(ob.eGet(
							ob.eClass().getEStructuralFeature("level"))
							.toString());
					if (bootLevel < 6) {
						setValid(false);
						setMessage("bootLevel should be > default bootlevel(5)");
						val = false;
					} else if (bootLevel > _maxBootLevel) {
						setValid(false);
						setMessage("bootLevel should be <= "
								+ "maximum bootLevel(" + _maxBootLevel +")");
						val = false;
					}
				}
	        ...
	        case Notification.ADD:
	            ...
	            if (newVal instanceof EObject) {
	                ...
	                String cwkey = (String) EcoreUtils.getValue(obj, ModelConstants.RDN_FEATURE_NAME);
	        ...
	        case Notification.ADD_MANY:
	            ...
	            for (int i = 0; i < objs.size(); i++) {
	                if (objs.get(i) instanceof EObject) {
	                    ...
	                    int bootLevel = Integer.parseInt(eObj.eGet(
								eObj.eClass()
										.getEStructuralFeature("level"))
								.toString());
	                    if (bootLevel < 6) {
	                    ...
	                    String key = (String) EcoreUtils.getValue(eObj, ModelConstants.RDN_FEATURE_NAME);
	        ...
	        case Notification.REMOVE:
	            ...
	            if (obj instanceof EObject) {
	                ...
	                String rkey = (String) EcoreUtils.getValue(ob, ModelConstants.RDN_FEATURE_NAME);
	        ...
	        case Notification.REMOVE_MANY:
	            ...
	            for (int i = 0; i < objs.size(); i++) {
	                if (objs.get(i) instanceof EObject) {
	                    ...
	                    String rk = (String) EcoreUtils.getValue(o, ModelConstants.RDN_FEATURE_NAME);
	...
	class BootLevelPushButtonDialog extends TitleAreaDialog
	{
	    ...
	    private BootLevelValidator _dialogValidator = null;
	     ...
	     *
	     */
	    public BootLevelPushButtonDialog(Shell shell, EObject parentObj, EClass eClass, Object value)
	    {
	        this(shell, parentObj, eClass, value, null);
	    }
	    /**
	     * @param shell   Shell
	     * @param eClass  Class
	            ...
	            Environment parentEnv)
	    {
	        ...
	        int maxBootLevel = Integer.parseInt(parentObj.eGet(
					parentObj.eClass().getEStructuralFeature("maxBootLevel")).toString());
	        if (value instanceof List) {
	            ...
	            _dialogValidator = new BootLevelValidator(this, maxBootLevel, _viewModel);
	        }
	    }
	    /**
	     * Save the Model.
