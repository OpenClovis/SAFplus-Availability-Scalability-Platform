/*******************************************************************************
 * ModuleName  : com
 * $File: //depot/dev/main/Andromeda/IDE/plugins/com.clovis.cw.editor.ca/src/com/clovis/cw/editor/ca/figure/ServiceInstanceFigure.java $
 * $Author: bkpavan $
 * $Date: 2007/01/03 $
 *******************************************************************************/
...
public class ServiceInstanceFigure extends ShadowRoundedRectangle implements
     ...
     */
    public ServiceInstanceFigure(NodeModel model)
    {
        super();
        _model = model;
        ...
        setBackgroundColor(SERVICEINSTANCE_COLOR);
