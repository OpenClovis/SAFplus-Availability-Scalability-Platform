 ...
 */
public class ClassPropertiesDialog extends PreferenceDialog
    implements ClassEditorConstants
{
     ...
     */
    public ClassPropertiesDialog(Shell parentShell,
            PreferenceManager pManager, EObject selObj, IProject project)
    {
		...
		Model resourceModel = ((GenericEditorInput) pdm.getCAEditorInput())
				.getModel();
		List modelList = resourceModel.getEList();
		_resourceList = ResourceDataUtils.getMoList(modelList);
...
*/
    ...
    private void addAlarmServicePage(EReference serRef)
    {
        ...
        ClassAssociationEditor editor = (ClassAssociationEditor) geInput.getEditor();
        ...
        EObject alarmRuleInfoObj = (EObject) editor.getAlarmRuleViewModel().getEList().get(0);
        _alarmRuleViewModel = new Model(editor.getAlarmRuleViewModel().getResource(), alarmRuleInfoObj).getViewModel();
        ...
        _alarmLinkViewModel = new Model(editor.getLinkViewModel().getResource(), linkObj).getViewModel();
        
        AssociateAlarmsPage alarmsPage = new AssociateAlarmsPage(
                _alarmModel, _alarmRuleViewModel, editor.getLinkViewModel(), _alarmRuleResObj, 
     ...
     *
     */
    private void enableMSOForResource() {
