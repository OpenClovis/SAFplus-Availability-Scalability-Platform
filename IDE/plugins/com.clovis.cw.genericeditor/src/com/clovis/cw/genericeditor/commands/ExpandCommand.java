/*******************************************************************************
 * ModuleName  : com
 * $File: //depot/dev/main/Andromeda/IDE/plugins/com.clovis.cw.genericeditor/src/com/clovis/cw/genericeditor/commands/ExpandCommand.java $
 * $Author: bkpavan $
 * $Date: 2007/01/03 $
 *******************************************************************************/
...
/**
 * @author pushparaj
 * Command for Expand nodes
 **/
public class ExpandCommand extends TreeCommand 
{
	/*private BaseEditPart _collapsedParent;*/
	/**
	 * Constructor
	 */
	public ExpandCommand(BaseEditPart part)
	{
		super("Expand", part);
	}
	/**
