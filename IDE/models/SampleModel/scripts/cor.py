...
/*******************************************************************************
*
* This file is auto-generated by OpenClovis IDE version 2.2.0
*
* clCorMetaStruct.h
*
* 
...
srcFileContents = headerTemplate.safe_substitute(DateTime = date, User = user)
...
headerFileContents = corheaderTemplate.safe_substitute(DateTime = date, User = user)
